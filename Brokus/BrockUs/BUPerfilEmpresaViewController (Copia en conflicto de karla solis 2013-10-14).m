...
@property (strong) BUSeccionPublicacionesViewController *irpub;
...
- (void)viewDidLoad
{
    ...
    self.irpub=[[BUSeccionPublicacionesViewController alloc] initWithNibName:@"BUSeccionPublicacionesViewController" bundle:nil];
...
- (IBAction)MisPublicacionesTapped:(id)sender {
    self.irpub.delegate=(id)self;
    [self presentViewController:self.irpub animated:YES completion:nil];
